...
<footer id="footer" class="footer">
    <!-- Bagian Hak Cipta -->
    <div class="copyright">
        <span> -Bersama Cakra, Wujudkan Impian Kecil Bersama- </span>
    </div>
    <!-- Bagian Kredit dan Informasi Tambahan -->
    <div class="credits">
        <!-- Semua tautan di footer seharusnya tetap utuh. -->
        ...
        <!-- <span>Made With by Group of 4</span> -->
    </div>
</footer><!-- End Footer -->
